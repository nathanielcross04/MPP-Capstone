...
xtlogit cluster govt_cont p_latino p_white p_unemp p_foreign_born p_poverty p_old i.year, fe or //VALID

xtprobit cluster govt_cont p_latino p_white p_unemp p_foreign_born p_poverty p_old i.year, re //VALID
	margins, dydx(govt_cont p_latino p_white p_unemp p_foreign_born p_poverty p_old)
...
forvalues i = 0/1 {
	preserve
	keep if cluster == `i'
	xtreg dist_own govt_cont p_latino p_white p_unemp p_foreign_born p_poverty p_old i.year, fe vce(cluster state) 
	xtreg extremity govt_cont p_latino p_white p_unemp p_foreign_born p_poverty p_old i.year, fe vce(cluster state) 
	restore
...
*Visualization
eststo clear
eststo reg1: xtlogit cluster govt_cont p_latino p_white p_unemp p_foreign_born p_poverty p_old, or
eststo reg2: xtlogit cluster govt_cont p_latino p_white p_unemp p_foreign_born p_poverty p_old i.year, fe or
...
forvalues i = 0/1 {
	...
	local c = `i' + 1
	eststo clear
	eststo reg1: xtreg dist_own govt_cont p_latino p_white p_unemp p_foreign_born p_poverty p_old i.year, fe vce(cluster state) 
	eststo reg2: xtreg extremity govt_cont p_latino p_white p_unemp p_foreign_born p_poverty p_old i.year, fe vce(cluster state) 
