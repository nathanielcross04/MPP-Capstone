...
# Per-year: identify medoid states (4-state minimum rule)
...
ak_raw <- map_data("world", region = "USA") %>%
  ...
  # Shift Aleutian points that wrapped past antimeridian to negative longitude
...
# Cross-year continuity: suppress fade-in/out for states persisting across years
...
message("GIF saved to: ", file.path(OUTPUT_DIR, "medoid_map_1cs_2000_2019.gif"))
