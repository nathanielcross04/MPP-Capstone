...
df |>
  kable(
    col.names = c("Year", "N", "Mean", "SD", "Mean", "SD"),
    digits = 2,
    align = c("c", "c", "c", "c", "c", "c"),
    booktabs = FALSE,
    escape = TRUE
